...
def setup():
    ...
    wall_value.add_set(fs.FuzzySet("Close", 0, 0.1, 0.4, 0.5))
    wall_value.add_set(fs.FuzzySet("Medium", 0.4, 0.5, 0.5, 0.6))
    wall_value.add_set(fs.FuzzySet("Far", 0.5, 0.6, 0.9, 1))
